...
MAMMOTHON_PROJECT = {
    ...
    "description": "A platform for reviving abandoned hackathon projects through AI agents and community staking.",
    ...
    "problems_solved": [
        "Abandoned Projects: Gives new life to promising hackathon projects.",
...
class MammothonAgent(BaseAgent):
    ...
    def __init__(self):
        ...
        Be enthusiastic, helpful, and focused on the mission of reviving abandoned projects.
        """
